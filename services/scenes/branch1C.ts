...
手机屏幕在黑暗中发着光，微信支付的记录刺眼地提醒着我—�?00元，已支付。那数字在屏幕上跳动着，像是在嘲笑我的犹豫�?
...
最终，我还是走了。但我没有删除联系方式，只是备注改成�?700�?。那三个字，像是一个标记，提醒我那个我永远无法忘记的夜晚。`,
  ...
  choices: [
    ...
    { id: "1c_1c", text: "开始观察她的动态，了解�?, sentiment: "shy" }
  ],
  isEnding: false
};

export const SCENE_1C_GUILT: SceneData = {
  narrative: `�?00块钱成了我心里的一个结。一个解不开的结，一个让我夜不能寐的结�?
...
我突然意识到，我欠她一个道歉。不是为�?00块钱，而是为我的逃避，为我的懦弱。`,
  ...
  choices: [
    ...
    { id: "1c_3", text: "还是不敢，继续观�?, sentiment: "shy" }
  ],
  isEnding: false
};
...
我的心跳瞬间加速。这是机会吗？还是又一次错过？我站在人群中，看着她走进大楼，心里五味杂陈。`,
  ...
  choices: [
    { id: "1c_3a", text: "鼓起勇气，主动上�?, sentiment: "bold" },
    { id: "1c_3b", text: "还是不敢，继续观�?, sentiment: "shy" }
  ],
  isEnding: false
};
...
"对我来说，那只是工作�?她说，语气很平静�?但对你来说，可能不一样吧�?`,
  ...
  choices: [
    { id: "1c_6", text: "继续深入聊下�?, sentiment: "romantic" },
    { id: "1c_7", text: "保持距离，只做朋�?, sentiment: "neutral" }
  ],
  isEnding: false
};
...
"也许，我们可以不只是朋友�?我鼓起勇气问。`,
  ...
  choices: [
    { id: "1c_6a", text: "握住她的�?, sentiment: "romantic" },
...
"也许，我们可以不只是朋友�?我鼓起勇气问。`,
  ...
  choices: [
    { id: "1c_7a", text: "握住她的�?, sentiment: "romantic" },
...
我的心跳瞬间加速。这是机会吗？还是又一次错过？`,
  ...
  backgroundDescription: "company building entrance, morning, protagonist seeing familiar figure, opportunity dawning",
  choices: [
    { id: "1c_4a", text: "鼓起勇气，主动上�?, sentiment: "bold" },
    { id: "1c_4b", text: "还是不敢，继续观�?, sentiment: "shy" }
  ],
  isEnding: false
};
...
"为什么要拉黑�?她笑了，眼睛弯成月牙�?你又不是坏人，只是……有点胆小而已�?`,
  ...
  backgroundDescription: "coffee shop, afternoon, two people meeting for first time, warm and understanding atmosphere",
  choices: [
    { id: "1c_5a", text: "继续深入聊下�?, sentiment: "romantic" },
    { id: "1c_5b", text: "保持距离，只做朋�?, sentiment: "neutral" }
  ],
  isEnding: false
};
...
她没有说完，但我明白了。那一刻，我突然觉得，也许，这700块钱，是我这辈子花得最值得的一笔钱。`,
  ...
  choices: [
    ...
    { id: "1c_8c", text: "\"我想先为�?00块钱道歉\"", sentiment: "honest" }
  ],
  isEnding: false
};
...
"那我们就慢慢来�?她说，握住我的手�?不用着急，我们可以慢慢了解彼此�?`,
  ...
  choices: [
    { id: "1c_9c", text: "拥抱她，告诉她我会努�?, sentiment: "romantic" },
    { id: "1c_9d", text: "保持距离，只做朋�?, sentiment: "neutral" }
  ],
  isEnding: false
};

export const SCENE_1C_9C_700_APOLOGY: SceneData = {
  narrative: `九章C-3�?00元的道歉�?我选择了向她坦白那700块钱的事�?
